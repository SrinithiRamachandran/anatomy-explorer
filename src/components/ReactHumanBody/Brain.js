...
export default function Brain() {
  ...
  const info = {
    name: "Brain",
    description:
      "The brain controls body functions, thought, memory, emotion, touch, motor skills, vision, breathing, temperature, and more."
  };

  const fillColor = hover ? "#FFD93D" : "#808080"; // Highlight on hover
